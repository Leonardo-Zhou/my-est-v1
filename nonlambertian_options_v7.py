...
class NonLambertianOptions:
    def __init__(self):
        ...
        self.parser.add_argument("--model_name",
                                 ...
                                 default="nonlambertian_" + time.strftime('%Y-%m-%d-%H-%M-%S'))
        ...
        # NON-LAMBERTIAN SPECIFIC LOSS WEIGHTS
        ...
        # NON-LAMBERTIAN DECOMPOSE DECODER OPTIONS
        self.parser.add_argument("--albedo_scales",
                                 nargs="+",
                                 type=int,
                                 help="scales used in the albedo branch",
                                 default=[4, 3, 2, 1, 0])
        self.parser.add_argument("--shading_scales",
                                 nargs="+",
                                 type=int,
                                 help="scales used in the shading branch",
                                 default=[4, 3, 2, 1, 0])
        self.parser.add_argument("--specular_scales",
                                 nargs="+",
                                 type=int,
