...
class NonLambertianResnetEncoderV3(nn.Module):
    """Pytorch module for a resnet encoder with mirror-link connections for non-Lambertian decomposition
    """
    def __init__(self, num_layers, pretrained, num_input_images=1):
        super(NonLambertianResnetEncoderV3, self).__init__()
        ...
        # Additional layers for mirror-link connections
        # These layers will be used to process features before passing them to the decoder
    ...
    def forward(self, input_image):
        ...
        self.features.append(x)
        processed_features.append(self.feature_processors[2](x))
